"""Rutas administrativas para gestionar solicitudes.

Este módulo expone endpoints que permiten a los administradores listar y
resolver solicitudes. El `__future__` import debe aparecer al inicio del
archivo para evitar el error de `SyntaxError: from __future__ imports must
occur at the beginning of the file` que puede darse si el import se desplaza
accidentalmente.
"""
